...
\lstdefinestyle{ymlcicd}{
	language=bash,
	basicstyle=\ttfamily\footnotesize,
	keywords={name, jobs, runs-on, runs, run, on, workflow_run, workflows, types, uses, with, steps, env, if, push, branches, permissions},
	keywords=[2]{true, false, completed, requested, in_progress}
